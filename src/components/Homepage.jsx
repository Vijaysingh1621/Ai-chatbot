        ...
        <div className="container_box">
            ...
            <div className="main_content">
                ...
                <div className='result' ref={answerRef}>
                                        {answer?( <div><p><Markdown>{answer}</Markdown></p> {answer && <button onClick={() => setCopy("Copied")}>{copy}</button>}</div> ):(<div className="text-gradient">Hii, {isLoaded && user ? user.firstName : "Loading..."}!<svg style={{margin:"10px",marginBottom:"-4px"}} version="1.1" viewBox="0 0 2048 2048" width="32px" height="32px" xmlns="http://www.w3.org/2000/svg">
