...
function Homepage() {
    ...
    return (<>
        ...
        <div className="container_box">
            ...
            <div  style={{ fontSize:"22px",fontWeight:"500", display:"flex", justifyContent:"start", alignItems:"center"}}> {isLoaded && user ? user.fullName : "Loading..."}<UserButton /><SignOutButton><button className="log-out-button">Log Out</button></SignOutButton></div>
                <h2>History</h2>
            ...
            <div className="main_content">
                ...
                <div className='result' ref={answerRef}>
                    {answer?( <div><p><Markdown>{answer}</Markdown></p> {answer && <button onClick={() => setCopy("Copied")}>{copy}</button>}</div> ):(<div className="text-gradient">Hii, {isLoaded && user ? user.firstName : "Loading..."}!<br/>How  can I help you Today?</div>)}
